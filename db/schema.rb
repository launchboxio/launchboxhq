...
ActiveRecord::Schema[7.0].define(version: 2023_11_10_022055) do
  ...
  create_table "addon_subscriptions", force: :cascade do |t|
    ...
    t.index ["project_id", "addon_id", "name"], name: "index_addon_subscriptions_on_project_id_and_addon_id_and_name", unique: true
